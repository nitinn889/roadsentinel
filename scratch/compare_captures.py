...
# 1. Viewport HighResShot
unreal.EditorLevelLibrary.set_level_viewport_camera_info(loc, rot)
shot_path = str(out_dir / "comp_viewport.png")
...
sc_path = out_dir / "comp_scenecapture.png"
...
print("Saved comp_viewport.png and comp_scenecapture.png")
