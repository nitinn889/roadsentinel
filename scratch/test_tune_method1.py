...
print("=" * 60)
print(">>> TUNE METHOD 1: INHERIT VIEWPORT + BIAS <<<")
print("=" * 60)
...
out_dir = Path("/home/nitin-nandakumar/Downloads/roadsentinel/env/output/smoke_test/tune_test")
...
for bias in [0.0, 1.5, 2.5, 3.5, 4.5]:
    ...
    time.sleep(0.2)
    comp.capture_scene()
    fname = f"inherit_bias_{bias:.1f}.png"
