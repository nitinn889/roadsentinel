...
print("=" * 60)
print(">>> TEST CAPTURE EVERY FRAME & TICK <<<")
print("=" * 60)
...
out_dir = Path("/home/nitin-nandakumar/Downloads/roadsentinel/env/output/smoke_test/cef_test")
...
# Enable capture_every_frame!
comp.set_editor_property("capture_every_frame", True)

# Set auto-exposure adaptation speed very fast
...
pps.set_editor_property("override_auto_exposure_speed_up", True)
pps.set_editor_property("auto_exposure_speed_up", 100.0)
pps.set_editor_property("override_auto_exposure_speed_down", True)
pps.set_editor_property("auto_exposure_speed_down", 100.0)
...
# Tick / sleep to let adaptation settle
for i in range(10):
    unreal.EditorLevelLibrary.redraw_all_viewports()
    time.sleep(0.1)

fname = "cef_histogram_settled.png"
