...
print("=" * 60)
print(">>> TEST MARKINGS Z ELEVATION FOR SCENECAPTURE2D <<<")
print("=" * 60)
...
# Raise all RS_Marking actors slightly above road (e.g. z = 1.5 cm)
...
for a in all_actors:
    if a.actor_has_tag(unreal.Name("RS_Marking")):
        ...
        # Set z to 1.5 cm above road, and thickness to 1.0 cm
        a.set_actor_location(unreal.Vector(loc_m.x, loc_m.y, 1.5), False, False)
...
time.sleep(0.3)
comp.capture_scene()
fname = "scenecapture_raised_markings.png"
...
print(">>> TEST MARKINGS Z COMPLETE <<<")
