...
class Config:
    ...
    # 2D Test Mode & Calibration
    test_mode_2d: bool = os.getenv("ROADSENTINEL_TEST_MODE_2D", "1").lower() in ("1", "true", "yes")
    candidate_min_area_px_2d: int = 50
    ...
    @property
    def candidate_min_area_px(self) -> int:
        return self.candidate_min_area_px_2d if self.test_mode_2d else self.candidate_min_area_px_3d

    @property
    def pothole_confidence_threshold(self) -> float:
        return self.pothole_confidence_threshold_2d if self.test_mode_2d else self.pothole_confidence_threshold_3d

    @property
    def anomaly_percentile(self) -> float:
        return self.anomaly_percentile_2d if self.test_mode_2d else self.anomaly_percentile_3d
