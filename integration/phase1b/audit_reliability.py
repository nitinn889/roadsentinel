...
2. **Domain Gating**: Standalone macro-level distribution shift quarantine based on DINOv2 20-NN cosine distance ($p_{99} = 0.4491$). Flags $100\\%$ of out-of-domain India dashcam frames and exhibits a $1.46\\%$ familiar false warning rate.
